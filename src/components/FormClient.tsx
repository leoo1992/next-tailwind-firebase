    ...
    <div className="transition-all duration-1000 ease-in-out">
      {useForms.id ? (
        <InputForm
          ...
          text="Id:"
          tipo="number"
          valor={useForms.firstFiveDigits}
          readonly
        />
      ) : (
        false
      ...
      <InputForm
        ...
        tipo="number"
        valor={idade}
        onChange={(value: any) => setIdade(useForms.validarIdade(value))}
        placeholder="Digite a idade"
        className="border-2 border-purple-600 focus:outline-none opacity-50 
        hover:opacity-100 transition-all duration-1000 ease-in-out"
      />
      {!useForms.idadeValida && (
        <h6
      ...
      <div className="flex justify-end mx-1 mb-1 mt-10 gap-2 transition-all duration-1000 ease-in-out">
        ...
        onClick={() =>{ props.clienteChanged?.(new Cliente(useForms.id, nome, idade)); props.onClick()}}
        >
          <svg
